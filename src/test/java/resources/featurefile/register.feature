...
Feature: Register Test
  ...
  Scenario: Verify That User Should Create Account Successfully
    ...
    And I enter "Bella" in first name field
    And I enter "Shah" in last name field
    And I select "8" day
    And I select "June" month
    And I select "1986" year
    And I enter email "ram123@ymail.com"
